...
boolean mainMenu = true, instructionsScreen = false, play = false, gameOver = false, options = false, powerUpScreen = false, characterSelection = false, devMode = true;
boolean musicOPT = false, SFXOPT = true, debugging = true; // User defined options, available in the options menu
...
final float speed1 = 1.2, speed2 = 1.4, speed3 = 1.6, jump1 = 1.2, jump2 = 1.3, sammieJumpBonus = 1.5, terrySpeedBonus = 1.5;
final int speed1Cost = 1000, speed2Cost = 1500, speed3Cost = 2500, jump1Cost = 1000, jump2Cost = 1750; // Costs may need to be balanced out in the game.
